...
const boska = localFont({
  src: [
    ...
    { path: "../../public/fonts/boska/Boska-Bold.woff2",         weight: "700", style: "normal" },
    { path: "../../public/fonts/boska/Boska-BoldItalic.woff2",   weight: "700", style: "italic" },
  ],
  variable: "--font-boska",
  display: "swap",
});
...
export default function RootLayout({ children }) {
  return (
    <html lang="en" className={`h-full antialiased ${switzer.variable} ${boska.variable}`} suppressHydrationWarning>
