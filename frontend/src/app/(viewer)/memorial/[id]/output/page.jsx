...
function OutputNav({ memorialName }) {
  return (
...
// ─── Placeholder tabs (Sungjun + Mendrika work on these) ────────
...
function AllPhotosTab({ albums }) {
  ...
  // Flatten photos in open album for lightbox navigation
  ...
  if (!albums || albums.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-24 text-center">
        ...
        <p className="text-slate-500 text-sm mt-1">Photos will appear here once contributors have submitted.</p>
      </div>
    );
  }
      ...
      <main className="min-h-screen bg-white px-6 py-10 sm:px-[50px]">
        <div className="mx-auto max-w-[960px]">
          ...
          <div className="mt-16 text-center">
            <p className="text-neutral-950 text-lg font-medium">Unable to load memorial</p>
