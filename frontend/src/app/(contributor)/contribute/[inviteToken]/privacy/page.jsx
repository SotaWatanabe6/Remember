...
import { beginContributorDraft, validateContributorInvite } from '@/services/contributorService.js';
...
export default function PrivacyPage() {
  ...
  useEffect(() => {
    validateContributorInvite(inviteToken).then(setInvite);
  }, [inviteToken]);
  ...
  async function handleAnonymous() {
    try {
      await beginContributorDraft(inviteToken, 'Anonymous');
  ...
  <main className="min-h-screen bg-r-bg text-r-text flex flex-col">
    <ContributorNav backHref={`/contribute/${inviteToken}/onboarding`} />
