  ...
  return (
    <>
      ...
      <div className={styles.container}>
        <section className="mx-auto flex w-full flex-col gap-14 sm:gap-15">
      ...
      <section className="mx-auto mt-16 flex w-full max-w-[947px] flex-col gap-16 px-6 sm:mt-20 sm:gap-20 sm:px-0">
        <h2 className="mx-auto w-full max-w-[745px] py-4 text-left text-lg font-medium uppercase tracking-[1px] sm:py-[31px] sm:text-[20px]">
