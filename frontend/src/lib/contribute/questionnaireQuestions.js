...
//
// Twelve relationship-specific question sets (US-31). Each set has 6
// questions using [first name] as a placeholder, substituted with the
// subject's actual first name via formatQuestionPrompt.
