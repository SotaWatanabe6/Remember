...
These inputs are processed into four outputs:

- 📖 **Story slideshow**
- ✨ **Constellation** — a connected-memory view
- 🎙️ **Voices archive**
- 🖼️ **Photo gallery**
...
**Architecture**
A three-layer platform: a contribution layer where families submit their inputs, an AI pipeline that structures the raw material, and an output microsite delivered to each family.
...
**Stack**
Next.js · Supabase · Node.js · Vercel · Render
